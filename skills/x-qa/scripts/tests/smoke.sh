...
echo "→ running precondition-chain smoke"
bash "$SKILL_DIR/scripts/tests/precondition-chain.sh"
echo "→ running precondition-cycle smoke"
bash "$SKILL_DIR/scripts/tests/precondition-cycle.sh"
